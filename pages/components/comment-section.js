            ...
            <section>
                <div className="container mx-auto py-20">
                    <div className="md:w-9/12 w-full mx-auto p-5">
                        ...
                        <div>
                            <h6 className="md:text-xl text-base font-productSansBold font-bold text-skin-dark mb-5">Comments</h6>
                            <div className="border border-gray-200 p-5 mb-3">
                                <p className="font-interRegular md:text-xl text-sm font-normal text-skin-muted mb-5">This is a text just to fill up the comment section with real text to save this text looking random and giving us a bt. This is a text just to fill up the comment section with real text to save this text looking random and giving us a bt.</p>
