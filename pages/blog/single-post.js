                    ...
                    <div className='flex md:flex-row flex-col gap-16'>
                        ...
                        <div className='relative w-full px-6 lg:pr-3 md:w-9/12 md:pl-20'>
                            ...
                            <div>
                                ...
                                <div className='mb-7'>
                                    <h6 className='font-productSansBold md:text-2xl text-xl font-bold text-skin-dark mb-5'>MyWallSt Blog</h6>
                                ...
                                <div className='mb-7'>
                                    <h6 className='font-productSansBold md:text-2xl text-xl font-bold text-skin-dark mb-5'>The Collaborative Fund: Morgan Housel</h6>
                            ...
                            <div>
                                <ul className='flex gap-10 md:justify-start justify-between items-center'>
                                    <li><Link href="#"><a>
                                        <p className='text-skin-primary font-interRegular font-normal md:text-lg text-sm flex gap-2 items-bottom'><span className='text-2xl'><FaRegThumbsUp /></span> <span className='font-bold'>Like</span> 2,562</p>
                                    </a></Link>
                                    </li>
                                    <li><Link href="#"><a>
                                        <p className='text-[#E86A34] font-interRegular font-normal md:text-lg text-sm flex gap-2 items-bottom'><span className='text-2xl rotate-180'><FaRegThumbsUp /></span> <span className='font-bold'>Dislike</span> 256</p>
                                    </a></Link>
                                    </li>
                                </ul>
